                    ...
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>Chittagong, Bangladesh</span>
                            </Stack >
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.facebook.com/rmstu.edu" target="_blank" rel="noopener noreferrer" >
                                    Facebook
                                </a>
                            </Stack >
